            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <article class="product-card">
                    ...
                    <div class="product-card-image-wrapper">
                        <img src="<?= !empty($product['primary_image']) ? BASE_URL . $product['primary_image'] : 'https://images.unsplash.com/photo-1469334031218-e382a71b716b?auto=format&fit=crop&w=600&q=80' ?>" alt="<?= htmlspecialchars($product['product_name']) ?>">
                        <div class="product-card-overlay">
                            <div class="product-card-icon" onclick="openQuickAdd(<?= $product['product_id'] ?? 0 ?>, '<?= htmlspecialchars($product['product_name']) ?>', <?= $product['price'] ?>, '<?= !empty($product['primary_image']) ? BASE_URL . $product['primary_image'] : 'https://images.unsplash.com/photo-1469334031218-e382a71b716b?auto=format&fit=crop&w=600&q=80' ?>')" title="Thêm vào giỏ hàng">
                                <i class="bi bi-bag-plus"></i>
                            </div>
                            <a href="<?= BASE_URL ?>?action=product-detail&id=<?= $product['product_id'] ?? 0 ?>" class="product-card-icon" title="Xem chi tiết">
                                <i class="bi bi-eye"></i>
                            </a>
                        </div>
                    </div>
                    <p class="text-uppercase small text-muted mb-1"><?= $product['category_name'] ?? 'Chưa phân loại' ?></p>
