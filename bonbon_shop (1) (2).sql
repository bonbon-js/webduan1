...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 26, 2025 lúc 10:05 PM
...
INSERT INTO `coupons` (`coupon_id`, `code`, `discount_percent`, `valid_from`, `valid_to`, `status`) VALUES
(1, 'WELCOME10', 10, '2025-01-01', '2025-12-31', 'active'),
(2, 'SUMMER20', 20, '2025-06-01', '2025-08-31', 'active'),
(3, 'VIP30', 30, '2025-01-01', '2025-12-31', 'active'),
(4, 'FLASH15', 15, '2025-11-01', '2025-11-30', 'active'),
(5, 'NEWUSER5', 5, '2025-01-01', '2025-12-31', 'active');
...
(1, 'Lê Phương Hà', 'phuongha9112006@gmail.com', '$2y$10$5Ky0UpeVLlJ2QIe47e76OOxzfKLvn3zGNNiR6/8pw0htR/LX.1fqe', NULL, NULL, 'admin', NULL, NULL, '2025-11-27 01:08:42', 'Lê', 'Phương Hà', 'female', '2025-11-21');
